...
class PlayerListAdapter: RecyclerView.Adapter<PlayerListAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(private val binding: PlayerListItemBinding): RecyclerView.ViewHolder(binding.root) {

        fun bind(playerList:Player){
            binding.playerListItem.text=playerList.name
